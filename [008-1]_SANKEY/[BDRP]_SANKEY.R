...
DF <- read.csv("Read_Data/expenditure.csv")
str(DF)
(DF2 <- DF)
...
sankeyPlot$setLib("[008-1]_SANKEY/libraries/sankey")

sankeyPlot$setTemplate(script = "[008-1]_SANKEY/libraries/sankey/layouts/chart.html")
...
DF5 <- read.csv("Read_Data/movie.csv")
